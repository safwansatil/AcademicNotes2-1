...
Formally, Say that A is the language of M1 and that M1 recognizes A and that A = L(M1).
  ![Automata](./img/finite%20automata.png)
- Some terms:
  ![Automata Terms](./img/finite%20automata%20terms.png)
...
![closurePropertyExmp](./img/closurePropertyExmple.png)
...
### Regular Expressions
Regex is a compact description of a set of strings or language.